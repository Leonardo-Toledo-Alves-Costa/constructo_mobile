...
class StockFilterPage extends StatefulWidget {
  final Function(String? tipo, String? lote, String? dataDe, String? dataAte)? onFilter;
  const StockFilterPage({super.key, required this.onFilter});

  @override
  State<StockFilterPage> createState() => _StockFilterPageState();
}
